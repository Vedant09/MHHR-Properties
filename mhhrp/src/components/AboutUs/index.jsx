...
const AboutUs = () => {
  return (
    <div className="about-us-component">
        ...
        <p className="header">About MHHR Properties</p>
      </div>
      ...
      />
      <InfoCard imageLink="https://img1.wsimg.com/isteam/stock/kayaJdA/:/rs=w:730,h:730,cg:true,m/cr=w:730,h:730"
      ...
      />
      <InfoCard imageLink="https://img1.wsimg.com/isteam/stock/6qj32Ve/:/rs=w:730,h:730,cg:true,m/cr=w:730,h:730"
